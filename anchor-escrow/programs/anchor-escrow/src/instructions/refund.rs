...
pub struct Refund<'info> {
    ...
    #[account(
        mut,
        close = maker,
        // verifies that the mint_a field in your Escrow account matches the mint_a account provided in the instruction context
        has_one = mint_a @ ErrorCode::InvalidMintA,
        // verifies that the maker field in your Escrow account matches the maker account provided in the instruction context
